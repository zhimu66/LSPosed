 ...
 */
public final class geekposedHelpers {
    private geekposedHelpers() {
    }
    ...
    public static Class<?> findClass(String className, ClassLoader classLoader) {
        if (classLoader == null)
            classLoader = geekposedBridge.BOOTCLASSLOADER;
        try {
    ...
    public static XC_MethodHook.Unhook findAndHookMethod(Class<?> clazz, String methodName, Object... parameterTypesAndCallback) {
        ...
        return geekposedBridge.hookMethod(m, callback);
    }
     ...
     * {@link geekposedBridge#hookMethod}.
     *
